...
modนี้สร้างขึ้นโดยให้ ai ช่วยเขียน code และระบบต่างๆ โดยตัวผมไม่ได้เป็นคนเขียนเอง แต่เป็นคนให้ไอเดียและเทสmod

modนี้ทำ HUD วงกลม 3 วง มุมล่างซ้ายแบบในรูปตัวอย่าง:
